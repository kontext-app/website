...
function App({ t }) {
    ...
    const items=[
      {
        id: 0,
        preHead: t('what_is_possible'),
        headline: t('what_is_possible_section1_description'),
        subHead: t('what_is_possible_section1_subhead'),
        headImage: webappSketch,
        features: [
          {
            id: 0,
            featureHead: t('what_is_possible_section1_item1'),
            featureSub: t('what_is_possible_section1_item1_description'),
            featureImage: webapp1
          },
          {
            id: 1,
            featureHead: t('what_is_possible_section1_item2'),
            featureSub: t('what_is_possible_section1_item2_description'),
            featureImage: webapp2
          },
          {
            id: 2,
            featureHead: t('what_is_possible_section1_item3'),
            featureSub: t('what_is_possible_section1_item3_description'),
      ...
      },
      {
        id: 1,
        preHead: t('what_is_possible'),
        headline: t('what_is_possible_section2_description'),
        subHead: t('what_is_possible_section2_subhead'),
        headImage: socialSketch,
        features: [
          {
            id: 0,
            featureHead: t('what_is_possible_section2_item1'),
            featureSub: t('what_is_possible_section2_item1_description'),
            featureImage: social1
          },
          {
            id: 1,
            featureHead: t('what_is_possible_section2_item2'),
            featureSub: t('what_is_possible_section2_item2_description'),
            featureImage: social2
          },
          {
            id: 2,
            featureHead: t('what_is_possible_section2_item3'),
            featureSub: t('what_is_possible_section2_item3_description'),
      ...
      },
      {
        id: 2,
        preHead: t('what_is_possible'),
        headline: t('what_is_possible_section3_description'),
        subHead: t('what_is_possible_section3_subhead'),
        headImage: recommendsSketch,
        features: [
          {
            id: 0,
            featureHead: t('what_is_possible_section3_item1'),
            featureSub: t('what_is_possible_section3_item1_description'),
            featureImage: recommends1
          },
          {
            id: 1,
            featureHead: t('what_is_possible_section3_item2'),
            featureSub: t('what_is_possible_section3_item2_description'),
            featureImage: recommends2
          },
          {
            id: 2,
            featureHead: t('what_is_possible_section3_item3'),
            featureSub: t('what_is_possible_section3_item3_description'),
    ...
    const headerItems= {
        id: 0,
        headline: t('header_line'),
        subHead: t('sub_head'),
        buttonInline: t('email_button_inline'),
        button: t('email_button_description'),
        headImage: webSketch
    }

    const pitchItems= {
        id: 0,
        preHead: t('pitch_head'),
        headline: t('pitch_head_line'),
        subHead: t('pitch_sub_head'),
        buttonInline: t('email_button_inline'),
        button: t('email_button_description'),
        headImage: webSketch
    }
    ...
    const technologyItems= {
        id: 0,
        preHead: t('technology_head'),
        headline: t('technology_head_line'),
        buttonInline: t('email_button_inline'),
        button: t('email_button_description'),
    }
    return (
        ...
        <nav className="flex flex-row items-center justify-between sticky top-0 bg-white section-wrapper font-sans z-10 shadow-sm">
          ...
          <div className="flex flex-row items-center color-">
            ...
            <a href="https://discord.gg/XSHJ4HM" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-900 hover:text-gray-700 inline-flex items-center">
              ...
              <span>{t('menu_chat')}</span>
            </a>
            <a href="https://twitter.com/kontextcontext" target="_blank" rel="noopener noreferrer" className="px-4 py-2 text-gray-900 hover:text-gray-700 inline-flex items-center">
